		...
		if ($this->input->post('daftar')) {
			...
			if (count($cek_data->result()) > 0 ) {
				...
				if ($level == 1) {
					...
					$this->session->set_flashdata('success','<b>Admin berhasil Login</b><br>Selamat Datang <i><b> Admin</b></i>');
					redirect('/admin');
				}elseif ($level == 2) {
				...
				$this->session->set_flashdata('error', '<b>Login Gagal</b><br>Username Dan Password Salah<br>Silahkan Coba Kembali');
				redirect('/home/prelogin');
			}
